<?php
  ...
  ?>
  <title>Termicas</title>
<main>	<!-- Creamos el contenido de la página -->
            <h2 class="h2producto"><a href="termicas.php" class="titulo-cat-prod">Termicas</a></h2>
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'camisetas-termicas' ORDER BY id ASC LIMIT 18");
                    if($query->num_rows > 0){ 
