...
<main>	<!-- Creamos el contenido de la página -->
            <title>Compresion</title>
            <h2 class="h2producto"><a href="compresion.php" class="titulo-cat-prod">Compresion</a></h2>
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'camisetas-compresion' ORDER BY id ASC LIMIT 18");
                    if($query->num_rows > 0){ 
