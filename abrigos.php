...
<main>	<!-- Creamos el contenido de la página -->
            ...
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'abrigos-plumas' ORDER BY id ASC LIMIT 6");
                    if($query->num_rows > 0){ 
                    ...
                    <h2 class="h2producto"><a href="anorak.php" class="titulo-cat-prod">Anorak</a></h2>
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'abrigos-anorak' ORDER BY id ASC LIMIT 6");
                    if($query->num_rows > 0){ 
                        while($row = $query->fetch_assoc()){
                    ?>  
                    <div class="producto">
                    ...
                    <h2 class="h2producto"><a href="hardshell.php" class="titulo-cat-prod">Hardshell</a></h2>
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'abrigos-hardshell' ORDER BY id ASC LIMIT 6");
                    if($query->num_rows > 0){ 
                        while($row = $query->fetch_assoc()){
                    ?>  
                    <div class="producto">
