...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="diseñocontacto.css"> <!-- Vinculamos el codigo CSS de la página -->
	</head>	
	<body>
	<header>
            <div class="menu">
...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="diseñocontacto.css">
	</head>
	<body>
	<header>
            <div class="menu">
