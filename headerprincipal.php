...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="diseñopagina_principal.css"> <!-- Vinculamos el codigo CSS de la página -->
        <link rel="stylesheet" type="text/css" href="popup.css"> <!-- Vinculamos el codigo CSS de la página -->
	</head>	
	<body>
	<header>
            <div class="menu">
...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="diseñopagina_principal.css">
        <link rel="stylesheet" type="text/css" href="popup.css"> <!-- Vinculamos el codigo CSS de la página -->
	</head>
	<body>
	<header>
