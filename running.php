...
<main>	<!-- Creamos el contenido de la página -->
            <h2 class="h2producto"><a href="running.php" class="titulo-cat-prod">Zapatos de trail running</a></h2>
            <div class="productos">
                <?php
                    //get rows query
                    $query = $db->query("SELECT * FROM mis_productos WHERE categoria = 'calzado-running' ORDER BY id ASC LIMIT 18");
                    if($query->num_rows > 0){ 
