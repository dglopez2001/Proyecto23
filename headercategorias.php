...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="diseñocategorias.css"> <!-- Vinculamos el codigo CSS de la página -->
	</head>	
	<body>
	<header>
            <div class="menu">
...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="diseñocategorias.css">
	</head>
	<body>
	<header>
            <div class="menu">
